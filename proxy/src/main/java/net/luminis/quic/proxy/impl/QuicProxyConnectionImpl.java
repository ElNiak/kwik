 ...
 */
package net.luminis.quic.proxy.impl;

import net.luminis.quic.DatagramSocketFactory;
import net.luminis.quic.QuicClientConnection;
import net.luminis.quic.QuicConstants.TransportParameterId;
...
import net.luminis.quic.impl.KeepAliveActor;
...
import net.luminis.quic.proxy.io.*;
...
import static net.luminis.quic.proxy.impl.QuicProxyConnectionImpl.EarlyDataStatus.None;
import static net.luminis.quic.proxy.impl.QuicProxyConnectionImpl.EarlyDataStatus.Requested;
import static net.luminis.quic.proxy.impl.QuicProxyConnectionImpl.EarlyDataStatus.Accepted;
import static net.luminis.quic.proxy.impl.QuicProxyConnectionImpl.EarlyDataStatus.Refused;

/**
 * Creates and maintains a QUIC connection with a QUIC server.
 */
public class QuicProxyConnectionImpl extends QuicConnectionImpl implements QuicClientConnection, PacketProcessor, TlsStatusEventHandler, FrameProcessor {
    ...
    private final ProxyConnectionConfig connectionProperties;
    ...
    private QuicProxyConnectionImpl(String host, int port, String applicationProtocol, long connectTimeout,
                                     ProxyConnectionConfig connectionProperties, QuicSessionTicket sessionTicket,
    ...
    private static class BuilderImpl implements Builder {
        ...
        protected ProxyConnectionConfig connectionProperties = new ProxyConnectionConfig();
        private String host;
        private int port;
        ...
        @Override
        public QuicProxyConnectionImpl build() throws SocketException, UnknownHostException {
            ...
            QuicProxyConnectionImpl quicConnection =
                    new QuicProxyConnectionImpl(host, port, applicationProtocol, connectTimeoutInMillis, connectionProperties, sessionTicket, Version.of(quicVersion),
