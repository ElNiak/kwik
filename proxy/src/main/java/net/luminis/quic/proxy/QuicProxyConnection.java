...
public interface QuicProxyConnection extends QuicConnection {
    ...
    static Builder newBuilder() {
        return (Builder) QuicProxyConnectionImpl.newBuilder();
    }
    ...
    interface Builder {
        ...
        QuicProxyConnection build() throws SocketException, UnknownHostException;
        ...
        /**
         * The maximum number of peer initiated bidirectional streams that the peer is
         * allowed to have open at any time.
        ...
        /**
         * The maximum number of peer initiated unidirectional streams that the peer is
         * allowed to have open at any time.
        ...
        /**
         * Sets the key manager that will be used to authenticate the client to the
         * server. The key manager should
         * contain the client's private key(s) and certificate(s) it wants to use for
         * authentication.
         * The first certificate whose issuer corresponds to one of the authorities
         * indicated by the server is used.
         * If none matches or if the server did not send the "certificate_authorities"
         * extension, the first certificate
